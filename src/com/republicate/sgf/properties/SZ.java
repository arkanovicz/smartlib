...
import com.republicate.sgf.types.*;
...
public class SZ extends RootProperty {
    ...
    private static ValueType valueType = new Or<com.republicate.sgf.types.Number,Compose<com.republicate.sgf.types.Number, com.republicate.sgf.types.Number>>(ValueTypes.NUMBER,new Compose<com.republicate.sgf.types.Number, com.republicate.sgf.types.Number>(ValueTypes.NUMBER,ValueTypes.NUMBER));
