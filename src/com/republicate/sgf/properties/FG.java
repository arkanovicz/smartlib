...
public class FG extends SetupProperty {
    ...
    private static ValueType valueType = new Or<None, Compose<com.republicate.sgf.types.Number, ComposedSimpleText>>(ValueTypes.NONE,new Compose<com.republicate.sgf.types.Number, ComposedSimpleText>(ValueTypes.NUMBER,ValueTypes.COMPOSED_SIMPLE_TEXT));
